...
class _AdminScreenState extends State<AdminScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    //Fill userData bloc
    blocUserData.getUserDataFromFirebase(widget.userUID, Provider.of<AppModel>(context));
...
//          stream: blocUserData.userData(widget.userUID),
          ...
          floatingActionButton: FloatingActionButton.extended(onPressed: newAccount, label: TextModel(text: Translations.of(context).btnEditorTimes, color: Theme.Colors.secondaryColor, size: max < 400 ? 12 : 15,), icon: Icon(Icons.add, color: Theme.Colors.secondaryColor, size: max < 400 ? 10 : 15,), backgroundColor: darkmode ? Theme.Colors.primaryDarkColor : Theme.Colors.primaryColor,),
        );
      }
    );
  }
...
//    });
  ...
  _fillPopupData(){
    ...
    choices = <Items>[
      Items(Text(menu, style: TextStyle(fontFamily: Theme.Fonts.primaryFont)), Icon(Icons.menu)),
      Items(Text(pass, style: TextStyle(fontFamily: Theme.Fonts.primaryFont)), Icon(Icons.security)),
      Items(Text(exit, style: TextStyle(fontFamily: Theme.Fonts.primaryFont)), Icon(Icons.exit_to_app)),
    ];
  }
