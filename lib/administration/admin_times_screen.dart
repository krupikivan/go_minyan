...
class AdminTimesScreen extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: FloatingActionButton.extended(
          heroTag: 'btnAdd',
          onPressed: () {
            _showAddTimePopup(context, size);
          },
          ...
          backgroundColor: darkmode
              ...
              : Theme.Colors.primaryColor,
          label: TextModel(
            text: Translations.of(context).btnNew,
  ...
  Widget _infoTable(context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [new BoxShadow(color: Colors.black45, blurRadius: 10.0)],
      ),
    );
  }
  ...
  Widget _getTableTitleName(String title) {
    return Padding(
      ...
      child: TextModel(
        ...
        size: 16,
        color:
            darkmode ? Theme.Colors.secondaryColor : Theme.Colors.primaryColor,
      ),
    );
  }
  ...
  void removeTime(String documentID, String day, String pray, Timestamp value,
      String dayDocumentId, AppModel appModel) {
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return LayoutBuilder(builder: (context, constrain) {
            ...
            return ListTile(
              ...
              onTap: () {
                removeTime(
                    Provider.of<AppModel>(context).userData.documentId,
                    day,
                    pray,
                    Timestamp.fromMillisecondsSinceEpoch(prayItem.type[index]),
                    day,
              ...
              StreamBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Align(
                        ...
                        child: DropModelWidget(context: context));
                  }),
              StreamBuilder<int>(
                  stream: blocAddNew.radioPray,
                  builder: (context, snapshot) {
                    _radioPray = snapshot.data;
                    return RadioModelWidget(
                        darkmode: darkmode,
                        sha: Translations.of(context).shajaritTitle,
                        min: Translations.of(context).minjaTitle,
                        arv: Translations.of(context).arvitTitle);
                  }),
              RaisedButton(
                color: darkmode
                    ? Theme.Colors.primaryDarkColor
                ...
                child: TextModel(
                  text: Translations.of(context).btnPopupTime,
                  color: Theme.Colors.secondaryColor,
                ),
              ),
              StreamBuilder<DateTime>(
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return Text(Translations.of(context).lblSelectedTime +
        ...
        buttons: [
          DialogButton(
            color: darkmode
                ...
                : Theme.Colors.primaryColor,
            onPressed: () {
              if (_timeOfDay == null || _dropDay == null) {
                ShowToast().show(Translations().adminDialogContentError, 10);
              } else {
...
//                blocTimes.saveNewTime(AppModel.of(context).userData.documentId, blocAddNew.getStringDay(_dropDay), blocAddNew.getPrayFromInt(_radioPray), _getDateTime(), AppModel.of(context));
                blocTimes.saveNewTime(
                    Provider.of<AppModel>(context).userData.documentId,
                    convertData.getWeekDayToString(_dropDay),
                    convertData.getPrayFromInt(_radioPray),
                    convertData.getDateTime(_timeOfDay));
            ...
            child: TextModel(
              text: Translations.of(context).btnAdd,
              size: 20,
              color: Theme.Colors.secondaryColor,
            ),
          )
