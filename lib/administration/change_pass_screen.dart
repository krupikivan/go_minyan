...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  Widget _passwordField(darkmode) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(
            color:
                darkmode ? Theme.Colors.hintDarkColor : Theme.Colors.hintColor),
  ...
  String _validatePass(String value) {
    if (value.isEmpty) return Translations.of(context).invalidPass;
    final RegExp nameExp = Validators.validatePassForm;
    if (!nameExp.hasMatch(value)) return Translations.of(context).invalidPass;
    return null;
  }
    ...
    return Row(
      ...
      children: <Widget>[
        RaisedButton(
          ...
          child: Text(Translations.of(context).btnSave),
  ...
  Widget _getIcon(IconData icon, darkmode) {
    return Icon(
      icon,
      color: darkmode ? Theme.Colors.secondaryColor : Theme.Colors.primaryColor,
    );
  }
  ...
  void _submitForm() {
    ...
    if (!form.validate()) {
      ...
      BlocProvider.of<AuthenticationBloc>(context)
          .dispatch(ChangePass(_passwordController.text));
    }
  }
