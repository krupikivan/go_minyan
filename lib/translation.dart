...
class Translations {
  ...
  String get appDesc {
    return Intl.message(
      'Una aplicacion creada sin fines de lucro con el objetivo de brindar al yehudi la facilidad de encontrar minianim en el pais de una manera muy facil y en un solo lugar.',
      name: 'appDesc',
    );
  }
  ...
  String get lblUserLastName {
    return Intl.message(
      'Apellido: ',
      name: 'lblUserLastName',
    );
  }
...
class TranslationsDelegate extends LocalizationsDelegate<Translations> {
  ...
  bool isSupported(Locale locale) =>
      ['en', 'es', 'he'].contains(locale.languageCode);
